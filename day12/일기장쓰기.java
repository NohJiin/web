...
public class 일기장쓰기 {
	...
	public void open() {
		...
		JTextArea contentText = new JTextArea(8,10);	// 5줄 10글자
		...
		btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// stream 만들기
				// 파일도 만들어주고 자바 프로그램과 file간의 연결통로(강물, stream)를 만들어준다
				...
				try {
					...
					// 처리할 내용을 넣어주세요
					System.out.println("error : 파일로 저장하는 중 문제가 생김");
				}
